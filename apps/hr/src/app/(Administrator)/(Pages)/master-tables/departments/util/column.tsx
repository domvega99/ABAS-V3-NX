...
const DepartmentColumns = [
    ...
    { id: 'division_name', label: 'Division', width: 400, sortable: false, show: true },
    ...
    { id: 'created_by_name', label: 'Created By', width: 300, sortable: false, show: true },
    { id: 'modified', label: 'Modified On', width: 170, sortable: true, show: true },
    { id: 'modified_by_name', label: 'Modified By', width: 300, sortable: false, show: true },
    { 
        id: 'stat', 
        label: 'Status', 
        width: 80, 
